                                    ...
                                    <div className="flex flex-col flex-1 ml-4">
                                      <div>
                                        <div className="flex justify-between text-base font-medium text-gray-900">
                                          ...
                                          <p className="ml-4">{formatter.format(product.variantPrice.amount)}</p>
                                        </div>
                    ...
                    {cart.length > 0 ? (
                      <div className="px-4 py-6 border-t border-gray-200 sm:px-6">
                        ...
                        <div className="mt-6">
                          <a
                            href={checkoutUrl}
                            className="flex items-center justify-center px-6 py-3 text-base font-medium text-white duration-300 bg-black border border-transparent rounded-md shadow-sm hover:bg-gray-800"
                          >
                            Checkout
                          </a>
                        </div>
                        <div className="flex justify-center mt-6 text-sm text-center text-gray-500">
                          <p>
                            ...
                            <button
                              type="button"
                              className="ml-1 font-medium duration-300 hover:text-gray-800"
                              onClick={() => setCartOpen(false)}
                            >
                              Continue Shopping
